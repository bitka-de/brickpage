  ...
  <nav class="border-b border-white shadow-sm bg-gradient-to-bl from-white">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            <a href="/dashboard" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-900 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300">
              <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
            </a>
            <a href="/editor" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300">
              <i class="fas fa-edit mr-2"></i>Editor
            </a>
            <a href="/settings" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300">
    ...
    <div class="hidden sm:hidden" id="mobile-menu" data-mobile-menu>
      <div class="px-2 pt-2 pb-3 space-y-1">
        <a href="/dashboard" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md bg-gray-50">
          <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
        </a>
        <a href="/editor" class="block px-3 py-2 text-base font-medium text-gray-500 rounded-md hover:text-gray-700 hover:bg-gray-50">
          <i class="fas fa-edit mr-2"></i>Editor
        </a>
        <a href="/settings" class="block px-3 py-2 text-base font-medium text-gray-500 rounded-md hover:text-gray-700 hover:bg-gray-50">
          <i class="fas fa-cog mr-2"></i>Settings
        </a>
